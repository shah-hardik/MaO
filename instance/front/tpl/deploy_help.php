<div class="row-fluid sortable">
    ...
    <div class="span12">
                ...
                <div class="box-content nopadding">
                    <div class="tabs-container">
                        <ul class="tabs tabs-inline tabs-left">
                            <li class="active">
                                <a data-toggle="tab" href="#first"><i class="icon-info"></i> <span>Custom Templates</span></a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#second"><i class="icon-bell"></i> <span>Deploy video</span></a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#thirds"><i class="icon-dollar"></i> <span>MaO code</span></a>
                            </li>
                            <li>
        ...
        <div id="box_responsive_two"> <!-- jQuery add span here -->
            <div class="box">
                <div class="box-title">
                    <h3><i class="icon-question-sign"></i>Deploy Help</h3>
                </div>
                <div class="box-content nopadding scrollable" data-height="350" data-visible="true" data-start="bottom">&nbsp;</div>
            </div>
        </div>
