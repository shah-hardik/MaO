...
function docReady(){
    ...
    $('.iphone-toggle').iphoneStyle({
       onChange:function(el){
           ...
           var binding = {'productToggle':'products','userToggle':'user','storeOff':'onoff'}
           var url = binding[func];
           if(el[0].checked == true){
               var checkedVal = 1;
           } else {
               var checkedVal = 0;
           }
           var data = {id:id,iphoneToggle:1,checked:checkedVal};
          //console.log(el[0].checked);
          _a({
            data:data,
            url:_U()+url,
            handler:function(r){
                if(typeof r.data.onoff != "undefined"){
                    location.href=_U()+ "onoff?time="+Math.random()*10;
                }
            }
        });
       }
